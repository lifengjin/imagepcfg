...
def parse_args(args):
    ...
    cmd.add_argument('--train_portion', required=False, type=str, choices=['1', '2', '4', '10', '20'], default='20') # 1/train_portion, ie 2 means 0.5, 20 means 0.05 of the whole training set
    ...
    cmd.add_argument("--model", default=None, help="actual path to save model")
    ...
    cmd.add_argument('--model_type', type=str, default='word', help='char or word ')
    ...
    cmd.add_argument('--train_path', required=True, type=str, help='The path to the training file.')
    cmd.add_argument('--train_image_path', type=str, default='', help='The path to the training image file.')
    cmd.add_argument('--train_portion', type=str, choices=['1', '2', '4', '10', '20'], default='20') # 1/train_portion, ie 2 means 0.5, 20 means 0.05 of the whole training set

    cmd.add_argument('--valid_path', required=True, type=str, default='', help='The path to the development file.')
    cmd.add_argument('--valid_gold_path', type=str, default='', help='The path to the development linetrees file.')
    cmd.add_argument('--valid_image_path', type=str, default='', required=False, help='The path to the training image file.')
